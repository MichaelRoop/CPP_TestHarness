...
///
///--------------------------------------------------------------------------------------
class MRTESCASE_API Engine : public mr_utils::singleton {
public:
...
MRTESCASE_EXP_TEMPLATE template class MRTESCASE_API std::allocator<MrTest::Engine*>;
MRTESCASE_EXP_TEMPLATE template class MRTESCASE_API std::vector<MrTest::Engine*>;
