...
///--------------------------------------------------------------------------------------
#if !defined(MR_TEST_ASSERT_H)
#define MR_TEST_ASSERT_H
...
MRTESCASE_API void CreateMsg(mr_utils::mr_stringstream& msgBuffer, const char* file, int line, mr_utils::mr_stringstream& userMsg);
...
/// @param	buffer	The message buffer to received the results.
/// @param	userMsg	The user message.
MRTESCASE_API void IsFalse(
	const char* file, int line, bool condition, mr_utils::mr_stringstream& buffer, mr_utils::mr_stringstream& userMsg);


MRTESCASE_API void FailOnNotThrow(
