...
///--------------------------------------------------------------------------------------
#if !defined(MR_TEST_SCRIPT_EXCEPTION_H)
#define MR_TEST_SCRIPT_EXCEPTION_H
...
///
///--------------------------------------------------------------------------------------
class MRTESCASE_API ScriptException : public mr_utils::mr_exception {
public:
