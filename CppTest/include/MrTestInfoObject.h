...
///--------------------------------------------------------------------------------------
#if !defined(MR_TEST_INFO_OBJECT_H)
#define MR_TEST_INFO_OBJECT_H

#include "MrTestDefines.h"
#include "IMrTestCaseArgument.h"
#include "mr_string.h"
#include <vector>
...
///
///--------------------------------------------------------------------------------------
class MRTESCASE_API TestInfoObject {
...
MRTESCASE_EXP_TEMPLATE template class MRTESCASE_API std::allocator<MrTest::TestInfoObject>;
MRTESCASE_EXP_TEMPLATE template class MRTESCASE_API std::vector<MrTest::TestInfoObject>;
