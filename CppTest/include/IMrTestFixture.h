...
///--------------------------------------------------------------------------------------
#if !defined(IMR_TEST_FIXTURE_H)
#define IMR_TEST_FIXTURE_H
...
MRTESCASE_EXP_TEMPLATE template class MRTESCASE_API std::allocator<MrTest::IFixture*>;
MRTESCASE_EXP_TEMPLATE template class MRTESCASE_API std::vector<MrTest::IFixture*>;
