...
MRTESCASE_API bool WriteToMsgBuff(mr_utils::mr_stringstream& buffer, const mr_utils::mr_string& msg, bool success);
...
/// @param	theCase	The test case to write to.
MRTESCASE_API void WriteToVerboseBuffHead(const char* file, int line, mr_utils::mr_stringstream& buffer);
...
///
/// @param	theCase	The test case to write to.
MRTESCASE_API void WriteToVerboseBuffMid(mr_utils::mr_stringstream& buffer);
