...
///--------------------------------------------------------------------------------------
#if !defined(IMR_TEST_CASE_H)
#define IMR_TEST_CASE_H
...
MRTESCASE_EXP_TEMPLATE template class MRTESCASE_API std::allocator<MrTest::ICase*>;
MRTESCASE_EXP_TEMPLATE template class MRTESCASE_API std::vector<MrTest::ICase*>;
